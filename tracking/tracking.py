...
class Tracking:
    ...
    def __init__(self, minHits = 3, maxAge = 5):
        ...
        self.track_id_list = deque(list(map(str, range(1000))))
    ...
    def update(self, unit_detections):
        ...
        for idx in unmatched_dets:
            ...
            #if(self.track_id_list == False):
            #    print("AAAAAAAAAAAAAAAAAAAAAAAA")
            self.track_id_list.rotate(-1) # assign an ID for the tracker
            tmp_trk.tracking_id = self.track_id_list.popleft()
        ...
        #print("Track : " + str(self.track_id_list))
